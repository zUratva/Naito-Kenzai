...
import com.aizoban.naitokenzai.presenters.QueuePresenter;
import com.aizoban.naitokenzai.presenters.QueuePresenterImpl;
...
public class QueueFragment extends Fragment implements QueueView, QueueMapper {
    ...
    public void initializeToolbar() {
        if (getActivity() instanceof AppCompatActivity) {
            ((AppCompatActivity)getActivity()).getSupportActionBar().setTitle(R.string.fragment_queue);
        }
    }
