...
public class AddToQueueAdapter extends BaseCursorAdapter {
    public AddToQueueAdapter(Context context) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (currentView == null) {
            currentView = LayoutInflater.from(mContext).inflate(R.layout.item_add_to_queue, parent, false);
