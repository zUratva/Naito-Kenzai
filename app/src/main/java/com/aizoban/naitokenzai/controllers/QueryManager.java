...
import com.aizoban.naitokenzai.controllers.databases.LibrarySQLiteOpenHelper;
        ...
        return Observable.create(new Observable.OnSubscribe<Integer>() {
            ...
            public void call(Subscriber<? super Integer> subscriber) {
                try {
                    ...
                    int amountDeleted = cupboard().withDatabase(sqLiteDatabase).delete(FavouriteManga.class, null, (String[]) null);
        ...
        return Observable.create(new Observable.OnSubscribe<Integer>() {
            ...
            public void call(Subscriber<? super Integer> subscriber) {
                try {
                    ...
                    int amountDeleted = cupboard().withDatabase(sqLiteDatabase).delete(RecentChapter.class, null, (String[])null);
